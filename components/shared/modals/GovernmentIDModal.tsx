...
const GovernmentIDModal = () => {
  ...
  const { closeModal } = useModalAction(ModalKey.GovtIDModal);
  const isOpen = useSelector((state: ReduxStore) => state.modal.GovtIDModal);
  ...
  const bodyContent = (
    <div className="w-full flex justify-center items-center flex-col gap-16">
      <ImageUpload
        ...
        type="front"
        heading="Upload front side of National ID"
      ...
      <ImageUpload
        ...
        handleDrop={handleDrop}
        type="back"
        heading="Upload back side of National ID"
